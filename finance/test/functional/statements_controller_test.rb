...
class StatementsControllerTest < ActionController::TestCase
  ...
  test "should create statement" do
    assert_difference('Statement.count') do
      post :create, statement: { account: @statement.account, closing_date: @statement.closing_date, due_date: @statement.due_date }
    end
  ...
  test "should update statement" do
    put :update, id: @statement, statement: { account: @statement.account, closing_date: @statement.closing_date, due_date: @statement.due_date }
    assert_redirected_to statement_path(assigns(:statement))
  end
